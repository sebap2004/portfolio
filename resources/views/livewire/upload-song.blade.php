<div class="flex flex-col items-center">
    ...
    <form class="p-2" wire:submit="create" enctype="multipart/form-data">
        ...
        <x-form.fileinput wire:model="form.cover_directory" class="file-input-primary w-96" name="cover image file" error="form.cover_directory" type="file"><span class="text-gray-400 text-xs ml-1"><i>2MB File Limit</i></span></x-form.fileinput>
