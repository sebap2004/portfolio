<div x-data="{ show: false, messageShow: '', typeShow: '' }"
     x-on:show-toast.window="show = true; messageShow = $event.detail.message; typeShow = $event.detail.type; setTimeout(() => { show = false; }, 4000); console.log('received, ' + event.detail.message + ' ' + event.detail.type)"
